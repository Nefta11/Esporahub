...
export const templates = [
  ...
  filminaCount: 37,
    filminas: [
      ...
      {id: 32, title: 'Análisis Comparativo de Perfil', order: 44, background: 'membretesimple.jpeg' },
      { id: 33, title: 'Identificación de los dilemas rentables', order: 45, background: 'membretesimple.jpeg' },
// { id: 34, title: 'Fracturas Antropológicas', order: 45, background: 'membretesimple.jpeg' },
// { id: 35, title: 'Matriz de Valores', order: 46, background: 'membretesimple.jpeg' },
// { id: 36, title: 'Psicografías Generales de los adjetivos', order: 47, background: 'membretesimple.jpeg' },
// { id: 37, title: 'Semiósferas Generales de los adjetivos', order: 48, background: 'membretesimple.jpeg' },
// { id: 38, title: 'Subportada A5. Micro-segmentación', order: 49, background: 'subportada2.jpeg' },
