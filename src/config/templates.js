...
export const templates = [
  ...
  filminaCount: 37,
    filminas: [
      ...
      { id: 26, title: 'Estudio de activación por tema', order: 38, background: 'membretessonar2.jpeg' },
      { id: 27, title: 'Subportada A4. Perfilado y Adjetivación', order: 39, background: 'subportada2.jpeg' },
      { id: 28, title: 'Análisis de humor social', order: 40, background: 'membretessonar2.jpeg' },
      { id: 29, title: 'Histograma del Humor Social', order: 41, background: 'membretessonar2.jpeg' },
